...
$pwd=$_POST['pass'];
$wp=md5($pwd);
$s="select * from register where uname='".$_POST['user']."' and pwd='$wp' or pwd='$pwd' ";
...
?>
						...
						<a href="Milma_Magazine_Reg.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Sign UP
							<i class="fa fa-long-arrow-right m-l-5"></i>
						</a>
						<br>	<a href="empindex.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							 Employee Sign In
							<i class="fa fa-long-arrow-right m-l-5"></i>
						</a>
					</div>
