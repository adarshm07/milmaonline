...
<body>
    <div class="mian-content">
		...
		<style>
		th{font-weight:bolder; color:#FF0000; background-color:#C2A2D5;}
		td{font-weight:bolder; color:#6633CC; background-color:#33CCCC;}
		</style>
                      <thead>
                        <tr>
                          <th>
...
$s="select * from ordermilk where status!='success'";
