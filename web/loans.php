                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-lg-auto text-left">
                                    <li class="nav-item active">
                                        <a class="nav-link" href="emphome.php">Home
...
$query = mysqli_query($db, "INSERT INTO loan values('null','".$_POST['name']."','".$_POST['on']."','".$_POST['dob']."','".$_POST['ano']."','".$_POST['reason']."','".$_POST['amt']."','".$_POST['dn']."')");
			if($query)
			{
				$total=$amt/$dn;//month
				$emi=$total/4;//intrest
				$fullamt=$amt+$emi;//total
				$temi=$fullamt/12;
				echo "Total amount will be";
				echo $fullamt;?><br><br><?php
				echo "EMI per month";
				echo $temi;
