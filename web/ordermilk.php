...
<body>
    <div class="mian-content">
		...
		<div style="text-align:center;">
								...
								<tr>
                                <th><br />Quantity</th><td><br />
                                <input type="number" name="qty" class="select" min="0" max="100" step="10" value="30">
                                </td>
								</tr>
								<tr>
								<th>Delivery Address</th><td><br /><br /><textarea name="address"></textarea></td>
								</tr>
								<tr><td><input type="submit" value="ORDER" name="order"/></td></form></tr>
								</table>
