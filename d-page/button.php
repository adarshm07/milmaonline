<div class="modal fade" id="del<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<?php
					$del=mysqli_query($conn,"select * from register where id='".$row['id']."'");
					$drow=mysqli_fetch_array($del);
				?>
				<div class="container-fluid">
					<h5><center>Firstname: <strong><?php echo $drow['uname']; ?></strong></center></h5> 
                </div> 
				</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                include_once('conn.php');
					$edit=mysqli_query($conn,"select * from register where id='".$row['id']."'");
				...
				<form method="POST" action="edit.php?id=<?php echo $erow['id']; ?>">
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="uname" class="form-control" value="<?php echo $erow['uname']; ?>">
						</div>
					</div>
